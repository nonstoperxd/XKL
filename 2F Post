...
while True:
    for line in lines:
        if len(line) > 3:
            ...
            print(Fore.GREEN + f'Comment Successfully Sent Done By 3rr0r inc - {line.strip()} at {formatted_time}' + Style.RESET_ALL)
            count += 1
            if count % 3 == 0:
                os.system('clear')
